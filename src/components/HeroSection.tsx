...
const HeroSection = () => {
  return <section className="w-full bg-blue-600 text-white relative">
      ...
      <div className="absolute left-0 top-1/3 flex flex-col">
        <a href="https://linkedin.com" className="bg-blue-700 p-4 hover:bg-blue-800 transition-colors">
          <LinkedinIcon size={24} />
        </a>
        <a href="https://github.com" className="bg-blue-700 p-4 hover:bg-blue-800 transition-colors">
          <GithubIcon size={24} />
        </a>
        <a href="https://twitter.com" className="bg-blue-700 p-4 hover:bg-blue-800 transition-colors">
          <TwitterIcon size={24} />
        </a>
      ...
      <div className="container mx-auto px-6 py-24 md:py-32 text-center">
        ...
        <a href="#projects" className="inline-block bg-white text-blue-600 font-bold py-4 px-8 rounded hover:bg-gray-100 transition-colors">
          PROJECTS
        </a>
      </div>
    </section>;
