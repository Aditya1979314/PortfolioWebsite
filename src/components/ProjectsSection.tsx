  ...
  return <section id="projects" className="w-full bg-white py-16 md:py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
          {projects.slice(0,4).map(project => <ProjectCard key={project.id} id={project.id} title={project.title} description={project.description} image={project.image} link={project.link} />)}
        </div>
